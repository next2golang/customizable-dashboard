export const TableHeader = () => {
  return (
    <ul className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 place-items-center bg-blue-900 text-white border p-1.5 sm:p-3 rounded-t font-semibold text-sm sm:text-base">
